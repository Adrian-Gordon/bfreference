'''
An Http Inference Server for a trained Keras Seq2Seq model
Usage: python httpinferenceserver <config filepath>
'''

import sys
import json

from httpserver import HttpServerEngine
...
seq2seqModel.load_weights()


httpServer = HttpServerEngine(config, seq2seqModel.doInference)
